          ...
          <div className="flex flex-1 flex-col bg-background mx-3 my-3 border border-border/60 rounded-2xl min-w-0 shadow-sm overflow-hidden">
            <header className="flex h-16 shrink-0 items-center justify-between border-b px-6 bg-card sticky top-0 z-10">
              <div className="flex flex-col">
                <h1 className="text-lg font-bold tracking-tight text-foreground">General Project Dashboard</h1>
                <p className="text-[11px] text-muted-foreground font-medium">Monitoring real-time progres portofolio R&D</p>
              </div>
              <span className="text-[10px] font-bold bg-primary/10 text-primary px-3 py-1.5 rounded-full uppercase tracking-widest border border-primary/20">
                Manager R&D
              </span>
            </header>
