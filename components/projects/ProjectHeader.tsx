import { Star, User, PencilSimpleLine, Trash } from "@phosphor-icons/react/dist/ssr"
...
export function ProjectHeader({ project, onEditProject, onDeleteProject }: ProjectHeaderProps) {
  const metaItems = [
        ...
        <div className="flex items-center gap-1">
          ...
          {onDeleteProject && (
            <Button
              ...
              className="rounded-lg text-rose-500 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10"
